...
function sumArray(sumArr) { //eslint-disable-line
    ...
    return [ 
        total,
        `${sumArr} was passed om as an array of numbers, and ${total} is their sum.`
    ];
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    return [
        totalProduct, 
        `The numbers ${multArr} have a product of ${totalProduct}.`
    ];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    function multiplyAnyArray(dynamicArray) {
        ...
        return [
            totalProduct,
            `The numbers ${dynamicArray} have a product of ${totalProduct}.`
        ];
    }
